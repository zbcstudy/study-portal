package com.wondertek.baiying.IdGeneration;

import java.util.Base64;

/**
 * Created by wd on 2019/1/29.
 */
public class Base62 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(encode(234));
        System.out.println(decode("3M"));
        System.out.println(new String(Base64.getEncoder().encode("zhaobicheng".getBytes())));
    }
